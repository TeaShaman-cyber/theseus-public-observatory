...
class RenderTests(unittest.TestCase):
    def setUp(self):
        self.snap = load_latest_snapshot(FIX, now=datetime(2026,7,24,13,30,tzinfo=timezone.utc), freshness_budget_seconds=3600)
    ...
    def test_home_is_base_path_aware_and_shows_credit_and_stale(self):
        html = render_home(self.snap, self.reports, [self.exp], base_path="/theseus-public-observatory/")
